...
Revision ID: 67abb77b6b01
Revises: 34c81522fe98
Create Date: 2022-07-26 12:41:28.899493
...
revision = '67abb77b6b01'
down_revision = '34c81522fe98'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('money_raised', sa.Integer(), nullable=True),
    sa.Column('voter_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['voter_id'], ['voters.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
